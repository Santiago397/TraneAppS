    ...
    private fun getInfo(): List<City> {
        ...
        try {
            ...
            for (i in 0 until citiesArray.length()) {
                ...
                val cityName = cityData.getString("pCity")
                val countryName = cityData.getString("country")
                val cityDescription = cityData.getString("description")
                val cityRate = cityData.getString("rate")
                val cityImages: ArrayList<String> = ArrayList()

                val imgArray = cityData.getJSONArray("urlImg")
